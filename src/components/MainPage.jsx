    ...
    <div className="bg-white ">
      <main>
        ...
        <a
          ...
          target="_blank"
          // className="z-50 fixed bottom-10 right-5 bg-green-500 text-white p-2 rounded-lg shadow-lg hover:bg-green-600 transition duration-300"
        ...
        >
          ...
          {/* <button class="w-10 h-10 flex items-center justify-center relative overflow-hidden rounded-full bg-white shadow-md shadow-gray-200 group transition-all duration-300">
            ...
            <div
              ...
              from-black via-black to-red-600 z-0 transition-all duration-500
              group-hover:top-0"
            ></div>
          </button> */}
